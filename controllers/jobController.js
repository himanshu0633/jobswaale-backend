...
exports.updateJob = async (req, res) => {
  try {
    ...
    const updated = await Job.findByIdAndUpdate(
      id,
      {
        jobTitle: jobTitle !== undefined ? jobTitle : job.jobTitle,
        jobCategory: jobCategory !== undefined ? jobCategory : job.jobCategory,
        ...
        jobLocations: Array.isArray(jobLocations) ? jobLocations : (jobLocations !== undefined ? jobLocations : job.jobLocations),
        description: description !== undefined ? description : job.description,
        jobSummary: jobSummary !== undefined ? jobSummary : (job.jobSummary || ''),
        detailedDescription: detailedDescription !== undefined ? detailedDescription : (job.detailedDescription || job.description || ''),
        ...
        experience: (experience || requiredExperience) !== undefined ? (experience || requiredExperience) : job.experience,
        requiredExperience: requiredExperience !== undefined ? requiredExperience : (job.requiredExperience || ''),
        ...
        salaryUnit: salaryUnit !== undefined ? salaryUnit : (job.salaryUnit || ''),
        salaryNegotiable: salaryNegotiable !== undefined ? salaryNegotiable : job.salaryNegotiable,
        noticePeriod: noticePeriod !== undefined ? noticePeriod : (job.noticePeriod || ''),
        joiningDate: joiningDate !== undefined ? joiningDate : job.joiningDate,
        shiftTiming: shiftTiming !== undefined ? shiftTiming : (job.shiftTiming || ''),
        jobExpiry: jobExpiry !== undefined ? jobExpiry : job.jobExpiry,
        benefits: benefits !== undefined ? benefits : (job.benefits || ''),
        aboutCompany: aboutCompany !== undefined ? aboutCompany : (job.aboutCompany || ''),
        skills: Array.isArray(skills) ? skills : (skills !== undefined ? skills : job.skills),
        languages: Array.isArray(languages) ? languages : (languages !== undefined ? languages : job.languages),
        candidateLocationPreference: candidateLocationPreference !== undefined ? candidateLocationPreference : (job.candidateLocationPreference || ''),
        screeningQuestions: screeningQuestions !== undefined ? screeningQuestions : (job.screeningQuestions || ''),
        ...
        district: district !== undefined ? district : job.district,
        city: city !== undefined ? city : job.city,
        companyName: companyName !== undefined ? companyName : job.companyName,
        contactPerson: contactPerson !== undefined ? contactPerson : job.contactPerson,
        email: email !== undefined ? email : job.email,
        phone: phone !== undefined ? phone : job.phone,
        currentPlan: currentPlan !== undefined ? currentPlan : job.currentPlan,
        planValidity: planValidity !== undefined ? planValidity : job.planValidity,
        document: document !== undefined ? document : job.document,
